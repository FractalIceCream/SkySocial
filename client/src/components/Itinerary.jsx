...
const Itinerary = ({profile}) => {
    ...
    const [itineraryList, setItineraryList] = useState(profile.wishlist || []); //.filter((trip) => !trip.itinerary ? trip.itinerary : null))
    // console.log(profile.wishlist?.itinerary);
