...
const Post = () => {
  ...
  return (
    <div class="w-submitPost shadow-inner-strong flex-grow max-w-custom h-post  bg-gray rounded-custom text-white">
      <div class="flex justify-between ">
        <h2 class="ml-7 mt-2"> Name Goes Here</h2>
        <h2 class="mr-7 mt-2">Date Goes Here</h2>
      </div>
      ...
      <div class="h-48 mt-3 bg-gray ">
        <div class=" flex justify-evenly flex-wrap w h-3/4">
          images go here if they exist
          <img class="max-w-full rounded-custom max-h-full h-auto" src=""></img>
        </div>
        <div class=" flex  max-w-custom overflow-auto   h-12 justify-center items-center text-center mt-2 ">
          <p>
            {" "}
            Text Goes here for Post Text Goes here for Post Text Goes here for
            Text Goes here for Post Text Goes here for Post flex-grow
          </p>
        </div>
      </div>
      ...
      <div class=" flex  max-w-custom justify-between">
        ...
        <input
          class="h-submitComment flex justify-center text-center text-white bg-gray-light  rounded-custom w-submitComment "
