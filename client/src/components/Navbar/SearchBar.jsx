...
const SearchBar = () => {
  ...
  const [themeState] = useTheme();
  const navbarStyles = {
    background: themeState.darkTheme ? 'white' : 'black',
    ...
    <form  className="flex flex-row">
      ...
      <div className="flex justify-center items-center">
        ...
        <button
          ...
          className=" ml-3 h-7 border border-black  rounded-custom w-32"
          style={navbarStyles}
        >
          Search
        </button>
  ...
  {modalOpen && (
        <div className="absolute flex justify-between items-center w-52 mt-2  rounded-custom border border-black ml-3 "
        style={navbarStyles}>
